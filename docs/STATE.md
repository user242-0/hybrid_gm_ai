...
current_target と narrative_targetの違い：

- actor.current_target = そのRCが意識している対象
- gui.selected_target = GUI上で選択中の対象
- hud.narrative_target = HUD候補生成上の物語対象
- world.current_focus = 演出焦点
