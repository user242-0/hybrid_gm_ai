...
actions = {
    ...
    "attack": {
        ...
        "requirements": {"has_enemy": True, "has_weapon": True, "same_location": True},
        "available_to": ["player", "npc"],
        "ui_visible": True,
    ...
    "swing_sword": {
        ...
        "action_layer": "GUI",
        "interaction_scope": "same_location",
        "requirements": {"has_enemy": True, "equipped_weapon_is": "sword", "same_location": True},
        "available_to": ["player", "npc"],
        "ui_visible": True,
        "heart": {"axis": "blue", "value": 200},
        "id_aliases": [],
    ...
    "engage_combat": {
        ...
        "action_layer": "GUI",
        "interaction_scope": "same_location",
        "requirements": {"has_enemy": True, "same_location": True},
        "available_to": ["player", "npc"],
        "ui_visible": True,
    ...
    "talk": {
        ...
        "action_layer": "GUI",
        "interaction_scope": "same_location",
        "requirements": {"has_target": True, "same_location": True},
        "available_to": ["player", "npc"],
        "ui_visible": True,
...
def _spec_from_new(action_id: str, data: Dict[str, Any]) -> ActionSpec:
    ...
    return ActionSpec(
        ...
        interaction_scope=data.get("interaction_scope"),
    )
